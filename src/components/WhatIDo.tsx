        ...
        <div className="what-box-in">
          ...
          >
            ...
            <div className="what-content-in">
              <h3>FULL-STACK</h3>
              <h4>Modern Web & Backend Architecture</h4>
              <p>
                Architecting end-to-end web and mobile applications with responsive
                interfaces, resilient backend microservices, database modeling, and
          ...
          >
            ...
            <div className="what-content-in">
              <h3>AI & DEVOPS</h3>
              <h4>Generative AI, Cloud & Infrastructure</h4>
              <p>
                Integrating Google Gemini AI models for intelligent automation,
                prompt engineering, Docker containerization, AWS cloud workflows,
              ...
              <div className="what-content-flex">
                ...
                <div className="what-tags">Netlify / Render</div>
              </div>
              <div className="what-arrow"></div>
            </div>
          </div>
